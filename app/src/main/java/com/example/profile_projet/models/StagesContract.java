...
public class StagesContract extends SQLiteOpenHelper {
    ...
    public StagesContract(Context context) {
    ...
    public boolean insertStage(String poste, String annee, String ecoleID) {
    ...
    public boolean updateStage(String id, String poste, String annee, String ecoleID) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
    ...
    public Integer deleteStage(String id) {
        SQLiteDatabase db = this.getWritableDatabase();
